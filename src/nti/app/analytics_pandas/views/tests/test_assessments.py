...
from nti.app.analytics_pandas.views.assessments import AssessmentsEventsTimeseriesReportView
...
class TestAssessmentsEvents(AppAnalyticsTestBase):
	...
	def test_std_report_layout_rml(self):
		...
		view = AssessmentsEventsTimeseriesReportView(context)
...
class TestAssessmentViews(PandasReportsLayerTest):
	...
	def test_assessment_view(self):
		...
		response = self.testapp.post_json('/dataserver2/pandas_reports/HighlightEventsReport',
                                    params,
